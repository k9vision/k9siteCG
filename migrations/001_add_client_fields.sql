-- Add client_name and email fields to clients table
ALTER TABLE clients ADD COLUMN client_name TEXT;
ALTER TABLE clients ADD COLUMN email TEXT;

-- Update existing test client with the new fields
UPDATE clients SET client_name = 'Test Client', email = 'test@example.com' WHERE id = 1;
